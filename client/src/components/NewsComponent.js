      ...
      <div className=" list-group news-list">
        <div className=" list-group-item list-group-item-action news-item">
          ...
          <div className="image-div">
            <img
              src={info[0].image ? info[0].image : imgUrl}
              alt="img"
        ...
        <div className=" list-group-item list-group-item-action news-item">
          ...
          <div className="image-div">
            <img
              src={info[1].image ? info[1].image : imgUrl}
              alt="img"
              className="news-image"
            />
          </div>
        ...
        <div className=" list-group-item list-group-item-action news-item">
          ...
          <div className="image-div">
            <img
              src={info[2].image ? info[2].image : imgUrl}
              alt="img"
              className="news-image"
            />
          </div>
        ...
        <div className=" list-group-item list-group-item-action news-item">
          ...
          <div className="image-div">
            <img
              src={info[3].image ? info[3].image : imgUrl}
              alt="img"
              className="news-image"
            />
          </div>
        ...
        <div className=" list-group-item list-group-item-action news-item">
          ...
          <div className="image-div">
            <img
              src={info[4].image ? info[4].image : imgUrl}
              alt="img"
              className="news-image"
            />
          </div>
